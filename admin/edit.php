...
<br/>
	...
	<a href="data-wifi.php">Lihat Semua Data</a>
	...
	global $link;
	$id = $_GET['id'];
	$query_mysql = mysqli_query($link, "SELECT * FROM wifi_public WHERE id_wifi='$id'")or die(mysqli_error());
	$nomor = 1;
	...
	<form action="update.php" method="post">		
		<table>
			<tr>
				<input type="hidden" name="id" value="<?php echo $data['id_wifi'] ?>">
				<td>Nama</td>
				<td>
			...
			<tr>
				<td>Long</td>
				<td><input type="text" name="long" value="<?php echo $data['long'] ?>"></td>					
			</tr>
			<tr>
				<td>Type</td>
